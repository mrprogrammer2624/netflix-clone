  ...
  return (
    <div className="hero-bg relative">
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        <form
          className="flex flex-col md:flex-row items-center justify-start gap-4 w-1/2"
          onSubmit={handleFormSubmit}
        >
          <NTInput
            type="email"
            placeholder="Email address"
            rootClassName="p-2 rounded flex-1 bg-black/80 border border-gray-700"
            value={email}
            onChange={(e) => setEmail(e.target.value)}
          />

          <button className="bg-red-600 text-nowrap text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center">
            Get Started
        ...
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          ...
          <div className="flex-1 relative">
            ...
            <video
              ...
              loop
            >
              {/* <source src={"/netflix-clone/hero-vid.m4v"} type="video/mp4" /> */}
            ...
            <div className="relative">
              ...
              >
                ...
                <div className=" flex justify-between items-center w-full">
                  ...
                  <img src={DownloadGif} alt="DownloadGif" className="h-12" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          ...
          <div className="flex-1 relative overflow-hidden">
            ...
            <video
              ...
              loop
            >
              {/* <source src="/netflix-clone/video-devices.m4v" type="video/mp4" /> */}
